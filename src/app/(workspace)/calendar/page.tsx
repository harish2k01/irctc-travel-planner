...
export default async function CalendarPage() {
  ...
  return <CalendarView tickets={tickets.map(serializeTicket)} holidays={holidays.map((holiday) => ({ id: holiday.id, name: holiday.name, date: holiday.date.toISOString().slice(0, 10), type: holiday.type }))} timeZone={user.timeZone} />;
}
